                    ...
                    <div
                        ...
                        <div class="mt-4 px-5 pb-5">
                            ...
                            <div class="mt-2 mb-5 flex items-center justify-between">
                                <p>
                                    <span class="text-3xl font-bold text-slate-900"> UGX {{ $car->price_per_day }}</span>
                                    <span
                                        class="text-sm text-slate-900 line-through">UGX {{ intval(($car->price_per_day * 100) / (100 - $car->reduce)) }}
                                    </span>
                                </p>
