...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/images/logos/logo1.png">
            ...
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 ">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl drop-shadow-2xl">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img loading="lazy" src="/images/logos/mobili.png" class="mr-3 h-12" alt="Flowbite Logo" />
                    </a>
                ...
                <div class="md:flex md:justify-between">
                    <div class="mb-12 md:mb-0 flex justify-center ">
                        <a href="" class="flex items-center">
                            <img loading="lazy" src="/images/logos/mobili.png" class="mr-3 h-24"
                                alt="Logo" />
                        </a>
                    </div>
